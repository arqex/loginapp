            ...
            <HStack justifyContent="space-between" alignItems="center" gap="4">
              <HStack gap="4">
                ...
                <VStack alignItems="flex-start" gap="1">
                  <Heading size="md">Welcome, {authContext.user.name}!</Heading>
              ...
              <VStack gap="3" alignItems="stretch">
                {userAccounts.map((account: UserAccount) => (
                  <Box
                    ...
                    borderRadius="md"
                    borderColor={
                      selectedAccountId === account.id ? "blue.500" : "gray.200"
                    }
                    bg={selectedAccountId === account.id ? "blue.50" : "white"}
                    cursor="pointer"
              ...
              {selectedAccount && (
                <Box>
                  <Text mb="3" fontWeight="medium">
                    As {authContext.role} in "{selectedAccount.name}", you can:
                  </Text>
